...
// --- Form 1: @COM(IID: "...") on a protocol synthesizes IID in extension P.Protocol

@COM(IID: "10000000-0000-0000-0000-000000000001")
protocol IWidget: IUnknown { }

let _: GUID = IWidget.IID

// --- Form 2: @COM(CLSID: "...") on a class synthesizes static var CLSID

@COM(CLSID: "20000000-0000-0000-0000-000000000002")
...
let _ = IWidget.CLSID // expected-error {{type 'IWidget' has no member 'CLSID'}}
